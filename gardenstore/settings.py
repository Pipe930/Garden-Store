"""
Django settings for gardenstore project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.carrito.context_procesors.importar_total_carrito',
            ],
        },
    },
]

WSGI_APPLICATION = 'gardenstore.wsgi.application'
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = "felidiossanchez930@gmail.com"
EMAIL_HOST_PASSWORD = "+felipe@930+"